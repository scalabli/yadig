...
class SessionInterface:
    ...
    def make_null_session(self, app: "API") -> NullSession:
    ...
    def get_cookie_name(self, app: "API") -> str:
    ...
    def get_cookie_domain(self, app: "API") -> t.Optional[str]:
    ...
    def get_cookie_path(self, app: "API") -> str:
    ...
    def get_cookie_secure(self, app: "API") -> bool:
        """Returns True if the cookie should be secure.  This currently
        just returns the value of the ``SESSION_COOKIE_SECURE`` setting.
        """
        return app.config["SESSION_COOKIE_SECURE"]

    def get_cookie_samesite(self, app: "API") -> str:
    ...
    def get_expiration_time(
        self, app: "API", session: SessionMixin
    ) -> t.Optional[datetime]:
    ...
    def should_set_cookie(self, app: "API", session: SessionMixin) -> bool:
    ...
    def save_session(
        self, app: "API", session: SessionMixin, response: "Response"
    ) -> None:
