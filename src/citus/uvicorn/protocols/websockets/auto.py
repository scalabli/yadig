...
try:
    ...
    try:
        ...
        from citus.uvicorn.protocols.websockets.wsproto_impl import WSProtocol

        AutoWebSocketsProtocol = WSProtocol
else:
    from citus.uvicorn.protocols.websockets.websockets_impl import WebSocketProtocol
