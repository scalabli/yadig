...
class AccessFormatter(ColourizedFormatter):
    status_code_colours = {
        1: lambda code: quo.echo(str(code), fg="bright_white"),
        2: lambda code: quo.echo(str(code), fg="green"),
        3: lambda code: quo.echo(str(code), fg="yellow"),
        4: lambda code: quo.echo(str(code), fg="red"),
        5: lambda code: quo.echo(str(code), fg="bright_red"),
    }
